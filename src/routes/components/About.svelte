...
<div class="text-center min-w-[40%] dark:text-gray-200 p-4 grid grid-cols-2" id="about">
	<div class="flex flex-wrap justify-center items-center p-10 text-lg max-w-xl ">
		...
		<p class="mb-2">
			In addition to my professional work, I have a variety of hobbies that keep me engaged and
		...
		<p>
			My hobbies reflect my love of creating and building, and I bring that same passion to my work
